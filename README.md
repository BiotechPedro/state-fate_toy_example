The notebook contains R code to run a toy example on how to design an state-fate experiment with lineage tracing tools such as expressed, integrated barcodes.
